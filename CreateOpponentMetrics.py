...
#### REALGM URL ####
urlOppoMetrics = "https://basketball.realgm.com/nba/team-stats/2019/Advanced_Stats/Opponent_Totals/Regular_Season"

###########################################
##### PULL OPPONENT METRICS FUNCTION #####
###########################################
...
def pandaCleanMetrics():
    ...
    fname_in = exportFile
    fname_out = 'csv/OpponentMetrics.csv'
...
exportFile = 'tempOppoMetrics.csv'
